...
employeeRouter.post('/', verifyJWT, validateEmployee, employeeController.createEmployee);
employeeRouter.get('/profile', verifyJWT, employeeController.getEmployeeProfile);
employeeRouter.put('/update', verifyJWT, validateEmployeeUpdate, employeeController.updateEmployeeProfile);
